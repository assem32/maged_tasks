...
class AssetsManger{
  ...
  static String acer='$imageDir/acer.png';
  static String acerLaptop='$imageDir/Acer-Predator-Helios-300-2021 1.png';
  static String google='$imageDir/Google__G__Logo 1.png';
